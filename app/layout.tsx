...
export const metadata: Metadata = {
  title: "Interviewer",
  description: "AI-powered Interviewer , helps you to prepare for your job interview",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${monaSans.className} antialiased  bg-neutral-950 min-h-[100vh] bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))] text-white overflow-x-hidden`}
      >
